...
export default function FeaturesCarousel() {
  ...
  return (
    ...
    >
      <Carousel.Slide className="bg-baseOne dark:text-primary py-4">
        <div className="flex flex-col gap-2 m-2 p-2">
          <PiDevices size={62} />
          <Text className="text-5xl">Fully Responsive Design</Text>
      ...
      <Carousel.Slide className="bg-primary text-black py-4">
        <div className="flex flex-col gap-2 m-2 p-2">
          <CgTimer size={62} />
          <Text className="text-5xl">Up-to-Date Articles</Text>
          <Text className="text-2xl">
      ...
      <Carousel.Slide className="bg-baseOne dark:text-primary py-4">
        <div className="flex flex-col gap-2 m-2 p-2">
          ...
          <Text className="text-5xl">Theming</Text>
          <Text className="text-2xl">
      ...
      <Carousel.Slide className="bg-primary text-black py-4">
        <div className="flex flex-col gap-2 m-2 p-2">
          ...
          <Text className="text-5xl">Dual Language Availability</Text>
          <Text className="text-2xl">
