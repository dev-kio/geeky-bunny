...
export default function Error404() {
  ...
  return (
    <div className="flex bg-primaryThree h-screen hover:bg-primary">
      <div className="flex items-center justify-center">
        <Text
          style={{ fontSize: '20vw' }}
          className="absolute italic font-black text-primaryTwo hover:text-primaryThree cursor-default"
        >
          404
        </Text>
